...
test_evaluator = dict(
    ann_file=
    '/data/JRDB_2022/train_dataset_with_activity/labels/jrdb_mmpose_train/val_individual_COCO.json',
    type='CocoMetric')
...
work_dir = './work_dirs/rtmpose-m_8xb256-420e_coco-256x192_jrdb'
